...
var age = 16
var height = 166
print("Your name is \(myName), your age is \(age), and your height is \(height)cm")
/*:
 - Experiment:
 ...
 */
print("You had \(4 + 4) hours of sleep so far this week")
/*:
 ## Control Flow
...
var bicycleCount = 4
if bicycleCount == 0 {
  print("There are no bicycles")
}
if bicycleCount == 1 {
    print("There is 1 bicycle")
} else {
  print("There are lots of bikes!")
}
...
switch bicyleCount2 {
case 0:
 print("There are no bicyles")
case 1:
 print("There is one bicyle")
default:
  print("TThere are a lot of bikes!")
}
